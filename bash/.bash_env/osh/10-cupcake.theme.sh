...
function _omb_theme_PROMPT_COMMAND() {
	PS1="\n${icon_start}${_omb_prompt_green}$(_omb_prompt_print_python_venv) ${_omb_prompt_bold_brown}${icon_user}\u${_omb_prompt_bold_teal}${icon_host}\h${_omb_prompt_bold_purple}${icon_directory}\W${_omb_prompt_normal}\$([[ -n \$(command git branch 2> /dev/null) ]] && echo \" on ${icon_branch} \")${_omb_prompt_white}$(scm_prompt_info)${_omb_prompt_normal}\n${icon_end}"
	PS2="${icon_end}"
}
